...
public interface CurrencyConvertorSoap {
    ...
    @RequestWrapper(localName = "ConversionRate", targetNamespace = "http://www.webserviceX.NET/", className = "pe.edu.upc.cliente.ConversionRate")
    @ResponseWrapper(localName = "ConversionRateResponse", targetNamespace = "http://www.webserviceX.NET/", className = "pe.edu.upc.cliente.ConversionRateResponse")
