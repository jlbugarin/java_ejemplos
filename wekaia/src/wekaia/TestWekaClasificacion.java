...
public class TestWekaClasificacion {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * Load the data
		 */
		DataSource source = new DataSource("f://zoo.arff");
		Instances data = source.getDataSet();
		System.out.println(data.numInstances() + " instances cargadas.");
		...
		vals[0] = 1.0; // hair {false, true} - pelo
		vals[1] = 0.0; // feathers {false, true} -  plumas
		vals[2] = 0.0; // eggs {false, true} - huevos
		vals[3] = 1.0; // milk {false, true} - leche
		vals[4] = 0.0; // airborne {false, true} - aerotransportado
		vals[5] = 0.0; // aquatic {false, true} - acuatico
